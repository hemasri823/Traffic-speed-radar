...
limit = 80  # km/hra
file = open("C:\\Users\\RGUKT\\Desktop\\TrafficRecord\\SpeedRecord.txt", "w")
file.write("ID \t SPEED\n------\t-------\n")
file.close()
class EuclideanDistTracker:
    ...
    def capture(self, img, x, y, h, w, sp, id):
        if (self.capf[id] == 0):
            ...
            file = 'C:\\Users\\RGUKT\\Desktop\\TrafficRecord\\ ' + n + '.jpg'
            cv2.imwrite(file, crop_img)
            self.count += 1
            filet = open("C:\\Users\\RGUKT\\Desktop\\TrafficRecord\\SpeedRecord.txt", "a")
            if (sp > limit):
                file2 = 'C:\\Users\\RGUKT\\Desktop\\TrafficRecord\\exceeded\\' + n + '.jpg'
    ...
    def end(self):
        print("details")
        file = open("C:\\Users\\RGUKT\\Desktop\\TrafficRecord\\SpeedRecord.txt", "a")
        file.write("\n------------\n")
        file.write("\n-------------\n")
        file.write("SUMMARY\n")
        file.write("-------------\n")
